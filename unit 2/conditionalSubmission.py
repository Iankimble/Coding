...
# their numerical grade, and show them the letter grade.
# your function should be able to process the grades as followed.
# if a grade number is below a 70, it is an F.
# if a grade is above 70 and below 80, it is a C.
